...
Set android_sdk_dir=E:\Tools\adt-bundle-windows-x86-20140321\
Set android_buildtool_dir=%android_sdk_dir%sdk\build-tools\android-4.4.2\
@Set android_tool_dir=%android_sdk_dir%sdk\tools\
@set PC_SDK_ROOT=%~dp0..\..\..\
...
call %android_buildtool_dir%aapt package -S res -A assets -M AndroidManifest.xml  -I %android_sdk_dir%sdk\platforms\android-19\android.jar -F %apk_file_name%
