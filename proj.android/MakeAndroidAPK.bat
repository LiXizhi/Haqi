...
Set android_buildtool_dir=%android_sdk_dir%\build-tools\19.1.0\
...
call "%android_buildtool_dir%aapt" add %apk_file_name% resources.arsc
call "%android_buildtool_dir%aapt" add %apk_file_name% lib/armeabi-v7a/libParacraft.so
call "%android_buildtool_dir%aapt" add %apk_file_name% lib/armeabi-v7a/libgnustl_shared.so
@rem call %android_buildtool_dir%aapt add %apk_file_name% lib/armeabi-v7a/gdbserver
